...
public class VeiculoMain {
	...
	public static void main(String[] args) {
		...
		System.out.printf("\nPara viagem Maringá a Blumenau será necessário %.1f tanques"
				+ "\nCada passageiro irá contribuir com R$ %.2f\n\n", quanTanq,divisao);
		...
		System.out.printf("\nPara viagem Maringá a Blumenau será necessário %.1f tanques"
				+ "\nCada passageiro irá contribuir com R$ %.2f", quanTanq,divisao);
		sc.close();
	}
